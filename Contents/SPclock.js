...
function SPclock(parent, hOffset, vOffset, zOrder, scale) {
	...
	o.zOrder = zOrder;
    	...
    	clock = newImage(frame, 0, 0, 182, 232, base + "clock.png", zOrder + 1),
...
SPclock.prototype.reScale = function (scale) {
    ...
    scaleImage(this.clock, 0, 0, 182, 232);
...
/*
// Test Code to run SPclock in Widget Tester
// Requires the SPclock image folder inside Widget Tester's Resources folder.

var scale = 1.0;
var theClock = new SPclock(mainWindow, 0, 100, 200, scale);
mainWindow.height = 100 + 182 * scale;
