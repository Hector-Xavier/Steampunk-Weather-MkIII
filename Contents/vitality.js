...
function buildVitality(bg, icon, city, temp, degree) {
	...
	u.setAttribute("style", "text-align: right;font-family: 'Futura', 'Arial Narrow'; font-stretch: condensed; font-size: 11px; color: #ffffff; -kon-shadow: 0px -1px rgba( 0, 0, 0, 0.7 )");
